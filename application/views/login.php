...
<body style="background: url('<?php base_url()?>assets/img/Splashscreen/splashscreen_prestige_background@2x.png') no-repeat; background-size: 100% 969px;">
    <div id="margin"></div>
    <div class="container col-lg-3 col-md-3 login_container">
      <form action="<?php base_url()?>index.php/home" id="login_form" method="post">
